...
function loadDataFromCSV() {
    ...
    try {
        ...
        const testUsers = [
            ['Широков Василий Матвеевич', '89215567841', 'pass1', 'login1', 'Менеджер'],
            ['Кудрявцева Ева Ивановна', '89215567842', 'pass2', 'login2', 'Специалист'],
            ['Гончарова Ульяна Ярославовна', '89215567843', 'pass3', 'login3', 'Специалист'],
            ['Гусева Виктория Данииловна', '89215567844', 'pass4', 'login4', 'Оператор'],
            ['Баранов Артём Юрьевич', '89215567845', 'pass5', 'login5', 'Оператор'],
            ['Менеджер по качеству', '89215567846', 'pass6', 'login6', 'Менеджер по качеству'],
            ['Петров Никита Артёмович', '89215567847', 'pass7', 'login7', 'Заказчик'],
            ['Ковалева Софья Владимировна', '89215567848', 'pass8', 'login8', 'Заказчик']
        ];
